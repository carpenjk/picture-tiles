...
function calcProps(_ref) {
  ...
  function getRowHeight() {
    var _gridHeight = gridHeight ? (0, _dataweaver.parseSizeUnits)(gridHeight) : undefined;

    console.log('🚀 ~ file: GridContainer.jsx ~ line 123 ~ getRowHeight ~ rowHeight', !!rowHeight);
    if (rowHeight) return rowHeight;
    return gridHeight ? "".concat(_gridHeight.value / rows).concat(gridHeight.unit) : '1fr';
  }
