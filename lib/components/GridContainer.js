...
var GridContainer = function GridContainer(_ref2) {
  ...
  var rowHeight = (0, _dataweaver.parseSizeUnits)(gridHeight).map(function (val) {
  ...
  return /*#__PURE__*/React.createElement(StyledGrid, {
    ...
    maxWidth: maxWidth,
    rowHeight: rowHeight
  }, children, /*#__PURE__*/React.createElement(_InlineSpinner["default"], {
