...
const GridContainer = ({
  ...
  const rowHeight = parseSizeUnits(gridHeight).map(val => `${val.value ? val.value / 2 : val.whole}${val.unit || ''}`);
  return /*#__PURE__*/_jsxs(StyledGrid, {
    colCount: colCount,
    gridHeight: gridHeight,
    maxWidth: maxWidth,
    rowHeight: rowHeight,
    children: [children, /*#__PURE__*/_jsx(InlineSpinner, {
