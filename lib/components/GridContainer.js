...
var StyledGrid = _styledComponents["default"].div(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  position: relative;\n  display: grid;\n  grid-auto-flow: row dense;\n  grid-template-rows: ", ";\n  grid-auto-rows: ", ";\n  grid-template-columns: ", ";\n  justify-items: stretch;\n  align-items: stretch;\n  height: ", ";\n  width: ", ";\n  max-width: ", ";\n  overflow: hidden;\n\n  > *:last-child {\n    grid-row: unset;\n    grid-column: unset;\n    max-height: unset;\n  }\n\n  & button {\n    width: 100%;\n    height: 100%;\n  }\n  & button > img {\n    flex: none;\n    object-fit: ", ";\n    height: 100%;\n    width: 100%;\n    cursor: pointer;\n  }\n  ", "\n"])), (0, _css.getProp)('rowHeight'), (0, _css.getProp)('rowHeight'), (0, _css.getProp)('gridTemplateColumns'), (0, _css.getProp)('gridHeight'), (0, _css.getProp)('gridWidth'), (0, _css.getProp)('maxGridWidth'), (0, _css.getProp)('imageFit'), (0, _css.breakpoint)(1)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n    display: grid;\n    grid-auto-flow: row dense;\n    grid-template-rows: ", ";\n    grid-auto-rows: ", ";\n    grid-template-columns: ", ";\n    justify-items: stretch;\n    align-items: stretch;\n    height: ", ";\n    width: ", ";\n    max-width: ", ";\n    & button > img {\n      object-fit: ", ";\n    }\n    > *:last-child {\n      grid-row: unset;\n      grid-column: unset;\n      max-height: unset;\n    }\n"])), (0, _css.getProp)('rowHeight'), (0, _css.getProp)('rowHeight'), (0, _css.getProp)('gridTemplateColumns'), (0, _css.getProp)('gridHeight'), (0, _css.getProp)('gridWidth'), (0, _css.getProp)('maxGridWidth'), (0, _css.getProp)('imageFit')));
