...
var StyledGrid = _styledComponents["default"].div(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  position: relative;\n  display: grid;\n  grid-auto-flow: row dense;\n  grid-template-rows: ", ";\n  grid-auto-rows: ", ";\n  grid-template-columns: ", ";\n  justify-items: stretch;\n  align-items: stretch;\n  height: ", ";\n  width: ", ";\n  max-width: ", ";\n  overflow: hidden;\n\n  > *:last-child {\n    grid-row: unset;\n    grid-column: unset;\n    max-height: unset;\n  }\n\n  & button {\n    width: 100%;\n    height: 100%;\n  }\n  & button > img {\n    flex: none;\n    object-fit: ", ";\n    height: 100%;\n    width: 100%;\n    cursor: pointer;\n  }\n  ", "\n"])), (0, _dataweaver.getProp)('rowHeight'), (0, _dataweaver.getProp)('rowHeight'), (0, _dataweaver.getProp)('gridTemplateColumns'), (0, _dataweaver.getProp)('gridHeight'), (0, _dataweaver.getProp)('gridWidth'), (0, _dataweaver.getProp)('maxGridWidth'), (0, _dataweaver.getProp)('imageFit'), (0, _themeweaver.breakpoint)(1)(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n    display: grid;\n    grid-auto-flow: row dense;\n    grid-template-rows: ", ";\n    grid-auto-rows: ", ";\n    grid-template-columns: ", ";\n    justify-items: stretch;\n    align-items: stretch;\n    height: ", ";\n    width: ", ";\n    max-width: ", ";\n    & button > img {\n      object-fit: ", ";\n    }\n    > *:last-child {\n      grid-row: unset;\n      grid-column: unset;\n      max-height: unset;\n    }\n"])), (0, _dataweaver.getProp)('rowHeight'), (0, _dataweaver.getProp)('rowHeight'), (0, _dataweaver.getProp)('gridTemplateColumns'), (0, _dataweaver.getProp)('gridHeight'), (0, _dataweaver.getProp)('gridWidth'), (0, _dataweaver.getProp)('maxGridWidth'), (0, _dataweaver.getProp)('imageFit')));
...
var GridContainer = function GridContainer(_ref) {
  ...
  console.log('🚀 ~ file: GridContainer.jsx ~ line 128 ~ GridContainer ~ images', images);

  var _useImageLoader = (0, _ImageLoader.useImageLoader)(),
      isCompletelyLoaded = _useImageLoader.isCompletelyLoaded; // const calculatedProps = mapProps(
  //   calcProps,
  //   unwindProps({
  //     ...props,
  //     images: [images],
  ...
  var calculatedProps = (0, _dataweaver.unwindProps)(_objectSpread(_objectSpread({}, props), {}, {
    images: [images]
  })).map(function (propsAry) {
    return calcProps(propsAry);
  });
