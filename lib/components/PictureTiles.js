...
var PictureTiles = function PictureTiles(_ref) {
  ...
  var _images = (0, _react.useMemo)(function () {
    return (0, _dataweaver.mapFlatProp)(function (_ref2) {
      var flatImages = _ref2.images,
          cWidth = _ref2.columnWidth,
          maxCWidth = _ref2.maxColWidth,
          rHeight = _ref2.rowHeight;
      return flatImages.map(function (img) {
        return _objectSpread({
          width: (maxCWidth || cWidth) * img.colSpan,
          height: rHeight * img.rowSpan
        }, img);
      });
    }, (0, _dataweaver.flattenProps)({
      images: [images],
  ...
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(_ImageLoader.ImageLoader, {
    ...
    children: /*#__PURE__*/(0, _jsxRuntime.jsx)(_Tiles["default"], {
      ...
      gridWidth: gridWidth,
      images: (0, _dataweaver.unflattenProps)(_images),
      maxColWidth: maxColWidth,
