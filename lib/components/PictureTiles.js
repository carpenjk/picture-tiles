...
var PictureTiles = function PictureTiles(_ref) {
  ...
  var currBrIndex = numImages && numImages[br.indexOfLower] ? br.indexOfLower || numImages.length - 1 : undefined;
  console.log('🚀 ~ file: PictureTiles.jsx ~ line 36 ~ currBrIndex', currBrIndex);
  return /*#__PURE__*/(0, _jsxRuntime.jsx)(_ImageLoader.ImageLoader, {
    numImages: numImages[currBrIndex],
