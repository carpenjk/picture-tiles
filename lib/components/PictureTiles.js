...
const PictureTiles = ({
  ...
  console.log('🚀 ~ file: PictureTiles.js ~ line 22 ~ PictureTiles ~ overlayButton', overlayButton); // mapping determines how many images to display based on provided number of images
  ...
  return /*#__PURE__*/_jsx(ImageLoader, {
    numImages: pCount,
    children: /*#__PURE__*/_jsx(Tiles, {
      ...
      children: /*#__PURE__*/_jsx(PictureTilesInner, {
