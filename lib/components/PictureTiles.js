...
var PictureTiles = function PictureTiles(_ref) {
  ...
  var numImages = (0, _react.useMemo)(function () {
    ...
    var indexedPropValue = (0, _dataweaver.getIndexedPropValue)(valAry, br.indexOfLower);
    console.log('🚀 ~ file: PictureTiles.jsx ~ line 40 ~ numImages ~ indexedPropValue', indexedPropValue);
