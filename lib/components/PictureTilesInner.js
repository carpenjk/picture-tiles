...
var PictureTilesInner = function PictureTilesInner(_ref) {
  ...
  var _useBreakpoints = (0, _UseBreakpoints.useBreakpoints)(theme),
      br = _useBreakpoints.br;

  console.log('br.indexOfLower', br.indexOfLower); // return images[br.current].map...

  return /*#__PURE__*/(0, _jsxRuntime.jsx)(_jsxRuntime.Fragment, {
    children: images[br.indexOfLower].map(function (img, i) {
