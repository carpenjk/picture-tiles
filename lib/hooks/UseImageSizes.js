...
var useImageSizes = function useImageSizes(images, fallbackWidth, fallbackHeight) {
      ...
      return {
        images: imgs.map(function (img) {
          return _objectSpread({
            width: (0, _propX.parseAndCalc)([width, img.colSpan], function (_ref2) {
            ...
            height: (0, _propX.parseAndCalc)([height, img.rowSpan], function (_ref4) {
              var _ref5 = _slicedToArray(_ref4, 2),
                  _height = _ref5[0],
                  rSpan = _ref5[1];

              return _height && rSpan ? _height * rSpan : undefined;
            })
          }, img);
        })
      };
  ...
  return (0, _propX.windProps)(_images).images;
};
